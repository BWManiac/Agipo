# Toolkits API (`/api/connections/available/toolkits`)
...
────────                           ───────                              ────────
Connection Tools UI  ──────►  /api/connections/available/toolkits/[slug]      ──►  toolkits.get(slug)
                     ──────►  /api/connections/available/toolkits/[slug]/tools ──►  tools.list(toolkit)
                     ──────►  /api/connections/available/toolkits/[slug]/triggers ──► triggers.list(toolkit)
```
...
### GET `/api/connections/available/toolkits/[slug]`
...
### GET `/api/connections/available/toolkits/[slug]/tools`
...
### GET `/api/connections/available/toolkits/[slug]/triggers`
