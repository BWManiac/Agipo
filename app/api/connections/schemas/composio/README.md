...
**Endpoint:** `GET /api/connections/schemas/composio`  
**Auth:** None
...
- `/api/connections/schemas/composio/toolkits` - Returns all toolkits with tool names (more detailed)

---

## Notes

This endpoint reads from local cache files, not from Composio directly. If the cache is empty or stale, use `/api/connections/schemas/composio/sync` to refresh it first.
