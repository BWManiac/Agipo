/**
 * GET /api/connections/schemas/composio/toolkits/[toolkitSlug]/[toolSlug]
 * 
...
export async function GET(
  _request: Request,
  { params }: { params: Promise<{ toolkitSlug: string; toolSlug: string }> }
) {
  try {
    const { toolkitSlug, toolSlug } = await params;
