...
**Endpoint:** `GET /api/connections/schemas/composio/toolkits/[toolkitSlug]/[toolSlug]`  
**Auth:** None
...
|-----------|------|----------|-------------|
| `toolkitSlug` | string | Yes | Toolkit slug (e.g., "gmail") |
| `toolSlug` | string | Yes | Tool slug (e.g., "GMAIL_SEND_EMAIL") |
...
- `/api/connections/schemas/composio/toolkits/[toolkitSlug]` - Returns all tools for a toolkit
