...
**Endpoint:** `GET /api/connections/schemas/composio/toolkits`  
**Auth:** None
...
- `/api/connections/schemas/composio` - Returns toolkit summaries only (no tools)
- `/api/connections/schemas/composio/toolkits/[toolkitSlug]/[toolSlug]` - Returns full schema for a specific tool

---

## Notes

This endpoint returns tool names and descriptions but not full parameter schemas. To get the complete schema for configuring a tool, use `/api/connections/schemas/composio/toolkits/[toolkitSlug]/[toolSlug]` after the user selects a specific tool.
