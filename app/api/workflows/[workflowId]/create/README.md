...
**Endpoint:** `POST /api/workflows/[workflowId]/create`  
**Auth:** None
...
**Note:** The `workflowId` parameter in the URL path is ignored - a new ID is always generated.
...
The workflowId parameter in the URL is intentionally ignored. This allows the frontend to use a consistent URL pattern (`/api/workflows/new/create`) while the backend always generates a fresh ID. This prevents ID conflicts and ensures uniqueness.
