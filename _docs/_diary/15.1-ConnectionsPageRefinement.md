...
The `/api/integrations/list` endpoint returned:
```json
{
  "id": "conn_abc123",
...
**New endpoint:** `DELETE /api/integrations/disconnect`
...
|------|--------|-------------|
| `app/api/integrations/disconnect/route.ts` | **Created** | DELETE endpoint for disconnecting |
| `app/api/integrations/list/route.ts` | Modified | Return `toolkitSlug` instead of `appName` |
| `app/api/integrations/services/composio.ts` | Modified | Added `disconnectAccount()` |
...
│                        useConnections()                          │
│                                                                  │
│  1. Fetch auth configs:  GET /api/integrations/auth-configs     │
│  2. Fetch connections:   GET /api/integrations/list             │
│                                                                  │
